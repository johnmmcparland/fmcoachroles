...
/**
 * Goalkeeping calculator (shot stopping or handling)
 * <p>
 * 
 * @copy; John McParland
 *        </p>
 ...
 */
public class GoalkeepingCalculator implements Calculator {

    /**
     * Logger for this class
     */
    private static final Logger LOGGER = Logger.getLogger(GoalkeepingCalculator.class);

    /**
     * Name of this calculator
     */
    private String name = "Goalkeeping";
    ...
    public float calculate(INonPlayer nonPlayer) {
        ...
        // Goalkeepers * 2 + ddm
        int val = nonPlayer.getGoalkeepers() * 2
