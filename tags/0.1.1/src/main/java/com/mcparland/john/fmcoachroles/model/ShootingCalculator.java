 ...
 */
public class ShootingCalculator implements Calculator {

    /**
     * Logger for this class
     */
    private static final Logger LOGGER = Logger.getLogger(ShootingCalculator.class);
    ...
    public float calculate(INonPlayer nonPlayer) {
        ...
        int val = nonPlayer.getTechnical() * 6 + nonPlayer.getAttacking() * 3
