 ...
 */
public class BallControlCalculator implements Calculator {
    
    /**
     * Logger for this class
     */
    private static final Logger LOGGER = Logger.getLogger(BallControlCalculator.class);

    /**
     * Name of this calculator
     */
    private String name = "Ball Control";
    ...
    public float calculate(INonPlayer nonPlayer) {
        ...
        int val = nonPlayer.getTechnical() * 6 + nonPlayer.getMental() * 3
